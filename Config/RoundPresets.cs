    ...
    internal static class RoundPresets
    {
        internal static SettingPreset[] Build() => new[]
        {
            P("Classic Hunt",
              ...
              "hide=30;hunt=300;end=15;pph=5;swap=1;tag=4;taunt=30;area=75;hits=2;chg=5;decoy=4;conc=1;concr=7;caught=Spectator;round=Continuous;time=1200;weapon=m1911;ff=1",
            ...
            P("Infection",
              ...
              "hide=30;hunt=360;end=15;pph=7;swap=1;tag=4;taunt=35;area=75;hits=2;chg=4;decoy=3;conc=1;concr=7;caught=Infection;round=Continuous;time=1200;weapon=m1911;ff=1",
            ...
            P("Side Hustle Party",
              ...
              "hide=45;hunt=420;end=15;pph=5;swap=1;tag=4;taunt=40;area=90;hits=2;chg=8;decoy=6;conc=2;concr=8;caught=Spectator;round=Continuous;time=1200;weapon=m1911;ff=1",
            ...
            P("Ranked Rules",
              ...
              "hide=30;hunt=300;end=15;pph=5;swap=1;tag=4;taunt=30;area=65;hits=2;chg=2;decoy=1;conc=0;concr=7;caught=Spectator;round=Continuous;time=1200;weapon=m1911;ff=0",
              recommended: "Best for 4-8", minP: 4, maxP: 8),

            P("Panic Room",
              "Tiny zone, short rounds, fast action. Ideal for \"just one more quick round\".",
              "hide=15;hunt=150;end=15;pph=4;swap=1;tag=4;taunt=20;area=40;hits=2;chg=2;decoy=2;conc=1;concr=6;caught=Spectator;round=Continuous;time=1200;weapon=m1911;ff=1",
            ...
            P("Deep Cover",
              ...
              "hide=60;hunt=600;end=15;pph=5;swap=1;tag=4;taunt=50;area=100;hits=2;chg=3;decoy=3;conc=1;concr=7;caught=Spectator;round=Continuous;time=1200;weapon=m1911;ff=1",
            ...
            P("Last Prop Standing",
              ...
              "hide=30;hunt=360;end=15;pph=5;swap=1;tag=4;taunt=30;area=75;hits=2;chg=4;decoy=3;conc=1;concr=7;caught=Spectator;round=Continuous;time=1200;weapon=m1911;ff=1",
            ...
            P("Blend In",
              ...
              "hide=45;hunt=360;end=15;pph=5;swap=1;tag=4;taunt=35;area=80;hits=2;chg=5;decoy=2;conc=1;concr=7;caught=Spectator;round=Continuous;time=1200;weapon=m1911;ff=1",
            ...
            P("Closing Time",
              ...
              "hide=30;hunt=360;end=15;pph=5;swap=1;tag=4;taunt=30;area=100;hits=2;chg=4;decoy=3;conc=1;concr=7;caught=Spectator;round=Continuous;time=1800;weapon=m1911;ff=1",
                                       ...
                                       string recommended = null, int minP = 0, int maxP = 0, bool experimental = false)
        {
            ...
            {
                Name = name, Hint = hint, Values = values,
